...
public class BaseRepositoryImpl implements  BaseRepository {
    ...
    public List queryName() throws Exception {
        ...
        String sql="SELECT f.ID COUNTY  ,f.TOWN ,f.VILLAGE ,f.HOUSEHOLD_NUM ,f.PERSON_NUMBER, f.NAME ,f.SEX ,f.IDENTIFICATION_NUMBER ,f.NUM ,f.RELATION ,f.NATION ,f.CULTURAL_LEVEL ,f.SCHOOL_IS\n" +
    ...
    public List queryPersonStatus() throws Exception {
        String sql="SELECT  f.ID COUNTY  ,f.TOWN ,f.VILLAGE ,f.HOUSEHOLD_NUM ,f.PERSON_NUMBER, f.NAME ,f.SEX ,f.IDENTIFICATION_NUMBER ,f.NUM, f.RELATION ,f.NATION ,f.CULTURAL_LEVEL ,f.SCHOOL_IS\n" +
                ...
                "p.IDENTIFICATION_NUMBER=substr(f.IDENTIFICATION_NUMBER,0,18) and p.nation in ('死亡','迁出（离开）本地')";
        entityManager.clear();
        return entityManager.createNativeQuery(sql,FpbData.class).getResultList();
    }
